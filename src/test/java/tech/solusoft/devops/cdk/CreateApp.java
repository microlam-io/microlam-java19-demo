...
public class CreateApp {
    ...
    public void createApp() {
        ...
        new AbstractStack(app, "microlam-java19-demo", 
			...
			protected void init(Construct scope, String id, StackProps props) {
				...
				boolean java = false; // false = native compilation | true = java lambda
				int version = 19; //Java version = 11 or 17 or 19 or 8
				...
				Function.Builder handlerBuilder = Function.Builder.create(this, "MicrolamJava19Demo")			    		  
		               .functionName("MicrolamJava19Demo")
			    ...
			    //Code
			    if (java) {
			    	handlerBuilder.code(Code.fromAsset("target/microlam-java19-demo-1.0-SNAPSHOT-aws-lambda.zip"));
			    }
			    else { //Native
			    	handlerBuilder.code(Code.fromAsset("target/microlam-java19-demo-1.0-SNAPSHOT-aws-lambda-native.zip"));			    	
			    }
		        ...
		        RestApi api = RestApi.Builder.create(this, "microlam-java19-demo-api")
		                .restApiName("microlam-java19-demo").description("MicrolamJava19Demo API.")
